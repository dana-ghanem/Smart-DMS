...
">
    ...
    <!-- 🔹 Search Form -->
    <form method="GET" action="<?php echo e(route('documents.search')); ?>" style="
        background: white;
        padding: 20px;
        border-radius: 12px;
    ...
    ">
        ...
        <!-- Search input -->
        <input type="text" name="query" value="<?php echo e(request('query')); ?>" placeholder="Search documents..." style="
            padding: 12px;
            width: 250px;
            border-radius: 8px;
            ...
            ">
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    >
                        ...
                        <p style="color: #555;"><?php echo e($doc['description']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php else: ?>
