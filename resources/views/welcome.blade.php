...
<body class="welcome-body">
    ...
    <div class="welcome-card">
        ...
        @auth
            {{-- Logged in: take them straight to their documents --}}
            <div class="welcome-actions">
                <a href="{{ route('documents.index') }}" class="btn btn-primary btn-full">
        ...
        @else
            ...
            <div class="welcome-actions">
                ...
                @if (Route::has('register'))
                    ...
                    <a href="{{ route('register') }}" class="btn btn-ghost btn-full">
                        Create an account
                    </a>
                @endif
            </div>
